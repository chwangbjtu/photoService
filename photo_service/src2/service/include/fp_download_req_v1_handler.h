#ifndef __FP_DOWNLOADLOAD_REQ_V1_HANDLER_H
#define __FP_DOWNLOADLOAD_REQ_V1_HANDLER_H

#include "fp_base_handler.h"

class fp_download_req_v1_handler: public fp_base_handler
{
public:
...
#endif//__FP_DOWNLOADLOAD_REQ_V1_HANDLER_H
